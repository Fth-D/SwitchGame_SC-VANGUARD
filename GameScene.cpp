...
const float bg_ScrollSpeed = 60.0f;
...
void Game::InitializeGame()			// ここにゲームシーン初期化コードを書く
{
	...
	Background_Layer1_A->SetPosition(MakeFloat3(0.0f, 0.0f, 0.0f));	//座標指定
	...
	Background_Layer1_B->SetPosition(MakeFloat3(0.0f, 0.0f, 0.0f));	//座標指定
	...
	Background_Layer2_A->SetPosition(MakeFloat3(0.0f, 0.0f, 0.0f));	//座標指定
	...
	Background_Layer2_B->SetPosition(MakeFloat3(0.0f, 0.0f, 0.0f));	//座標指定
	...
	Background_Layer3_A->SetPosition(MakeFloat3(0.0f, 0.0f, 0.0f));	//座標指定
	...
	Background_Layer3_B->SetPosition(MakeFloat3(0.0f, 0.0f, 0.0f));	//座標指定
