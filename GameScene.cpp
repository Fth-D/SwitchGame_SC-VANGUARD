...
void Game::InitializeGame()			// ここにゲームシーン初期化コードを書く
{
	...
	Background_Layer1_far->GetSprite().SetPolygonSize(MakeFloat2(11520.0f, 1080.0f));	//サイズ指定
	Background_Layer1_far->GetSprite().LoadTexture("rom:/texture/Background/layer1_far.tga");	//画像読み込み
	Background_Layer1_far->GetSprite().DivideAnimationCells(1, 1);	//テキスチャーが縦横何分割になっているか指定
	Background_Layer1_far->GetSprite().CreateAnimation("Background_Layer1_far", 0, 0);	//アニメーションを作成（０フレイムなので１コマ）
	...
	Background_Layer2_mid->GetSprite().SetPolygonSize(MakeFloat2(11520.0f, 1080.0f));	//サイズ指定
	Background_Layer2_mid->GetSprite().LoadTexture("rom:/texture/Background/layer2_mid.tga");	//画像読み込み
	Background_Layer2_mid->GetSprite().DivideAnimationCells(1, 1);	//テキスチャーが縦横何分割になっているか指定
	Background_Layer2_mid->GetSprite().CreateAnimation("Background_Layer2_mid", 0, 0);	//アニメーションを作成（０フレイムなので１コマ）
	...
	Background_Layer3_near->GetSprite().SetPolygonSize(MakeFloat2(11520.0f, 1080.0f));	//サイズ指定
	Background_Layer3_near->GetSprite().LoadTexture("rom:/texture/Background/layer3_near.tga");	//画像読み込み
	Background_Layer3_near->GetSprite().DivideAnimationCells(1, 1);	//テキスチャーが縦横何分割になっているか指定
	Background_Layer3_near->GetSprite().CreateAnimation("Background_Layer3_near", 0, 0);	//アニメーションを作成（０フレイムなので１コマ）
